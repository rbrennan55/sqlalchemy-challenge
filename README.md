...
To receive all points, your Flask application must include a precipitation route that:
...
To receive all points, your Flask application must include a start route that:
